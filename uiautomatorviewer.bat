...
set java_exe=
call plugins\uiautomatorviewer\find_java.bat
...
if exist %frameworkdir%\%jarfile% goto JarFileOk
    set frameworkdir=plugins\uiautomatorviewer
...
echo "%java_exe%" "-Djava.ext.dirs=%javaextdirs%" "-Dcom.android.uiautomator.bindir=%prog_dir%" -jar %jarpath% %*
