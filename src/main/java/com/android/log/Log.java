	        ...
	        while(true){
	        	try{
	        		...
	        		if(!preTask.trim().equals(logInfo.task.trim())){
	        			...
	        			taskRoot.setImage(new Image(display, ClassLoader.getSystemResourceAsStream("icons/task.png")));
	        			...
	        			column_1.setImage(new Image(display, ClassLoader.getSystemResourceAsStream("icons/passed.png")));
	        			...
	        			colRoot.setImage(new Image(display, ClassLoader.getSystemResourceAsStream("icons/passed.png")));
	        			...
	        			if(logInfo.result == NGOK.OK){
	        				iPass +=1;
	        				column_2.setImage(new Image(display, ClassLoader.getSystemResourceAsStream("icons/passed.png")));
		        		}else{
		        			iFail+=1;
		        			column_1.setImage(new Image(display, ClassLoader.getSystemResourceAsStream("icons/failed.png")));
		        			column_2.setImage(new Image(display, ClassLoader.getSystemResourceAsStream("icons/failed.png")));
		        			colRoot.setImage(new Image(display, ClassLoader.getSystemResourceAsStream("icons/failed.png")));
		        		}
	        			...
	        			if(logInfo.loop == loop){
	        				...
	        				if(logInfo.name.equals(previous)){
	    	        			...
	    	        			if(logInfo.result == NGOK.OK){
	    	        				iPass +=1;
	    	        				column_x.setImage(new Image(display, ClassLoader.getSystemResourceAsStream("icons/passed.png")));
	    		        		}else{
	    		        			iFail+=1;
	    		        			column_1.setImage(new Image(display, ClassLoader.getSystemResourceAsStream("icons/failed.png")));
	    		        			column_x.setImage(new Image(display, ClassLoader.getSystemResourceAsStream("icons/failed.png")));
	    		        			colRoot.setImage(new Image(display, ClassLoader.getSystemResourceAsStream("icons/failed.png")));
	    		        		}
	        				}else{
	        					//case: Run 1
