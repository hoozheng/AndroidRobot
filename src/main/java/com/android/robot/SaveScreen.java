    ...
    public String open() {
        ...
        if (folders != null) {
            for (int i = 0; i < folders.size(); i++) {
                ...
                //Project folders
                Vector<File> vecFolders = getFolders(folders.get(i).getName());
                ...
                if (vecFolders != null) {
                    for (int j = 0; j < vecFolders.size(); j++) {
                        ...
                        //Script node
                        Vector<String> vecScripts = getScripts(vecFolders.get(j).getParent() + "\\"
                                                               + vecFolders.get(j).getName());
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (dir.endsWith("\\Pictures")) {
                    ...
                    if (name != null && !name.trim().equals("")) {
                        ...
                        boolean exist = new File(".\\workspace\\" + result).exists();
                        ...
                        lblError.setForeground(new Color(display, new RGB(255, 0, 0)));
