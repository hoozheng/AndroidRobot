...
public class Monkey extends Dialog {
    ...
    private static ArrayList<MonkeyPackage> listCase                = new ArrayList<MonkeyPackage>();
    ...
    public Object open() {
        ...
        //Table
        tvPackageName = new TableViewer(compLeft, SWT.MULTI | SWT.FULL_SELECTION | SWT.BORDER
