...
public class SetCheckPoint2 {
    ...
    public SetCheckPoint2(Shell parent, String project, String node) {
        this.parent = parent;
        this.project = project;
        this.node = node;
        this.obj_path = this.project
                        + this.node.substring(this.node.indexOf(Constants.FILE_SEPARATOR),
                            this.node.length());
    }
    ...
    private Area loadScreenArea(String pngFile) throws Exception {
        Area area = null;
        String xmlArea = project + "/screen_area.xml";
    ...
    public void drawRectangle(GC gc) {
        ...
        if (gc != null) {
            ...
            tempImage = new Image(Display.getDefault(),
                ClassLoader.getSystemResourceAsStream("icons/temp.png"));
    ...
    public void canvasDrawImage(GC gc) {
        try {
            FileInputStream input = new FileInputStream(new File(this.obj_path));
                ...
                if (imagesList != null && imagesList.size() > 0) {
                    ...
                    if (image != null) {
                        gc.drawImage(image, 0, 0, image.getImageData().width,
                            image.getImageData().height, 0, 0, 320, 480);
